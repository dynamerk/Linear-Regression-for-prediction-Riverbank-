...
# Prepare data for regression (decades numbered 1 and 2)
X_train = np.array([[1], [2]])
X_pred = np.array([[3]])  # For prediction of 2024–2034 decade

# Predict displacement for 2024-2034 for each location
predicted_2024_2034 = []
